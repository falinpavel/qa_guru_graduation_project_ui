"""
Модуль конфигурации pytest для автоматизированного тестирования браузеров.
...
- Валидация параметров выполнения с использованием Pydantic моделей

Зависимости:
- pytest: Фреймворк для тестирования
- selene: Библиотека для автоматизации браузеров
- selenium: Биндинги для WebDriver
...
def pytest_addoption(parser: pytest.Parser) -> None:
    """
        ...
        Пример:
            pytest tests/ --context=chrome_selenoid
            pytest tests/ --context=firefox_local -v
        """
    parser.addoption(
        "--context",
...
def load_environment() -> None:
    ...
    Эта фикстура выполняется один раз за тестовую сессию и загружает переменные
    окружения из .env файлов с использованием python-dotenv. Она гарантирует,
